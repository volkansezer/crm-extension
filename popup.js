...
const apiUrl = "https://ankaserelektronik.com/crm/api/ext/";
...
async function main(){
	...
	if(!currentTab.url.includes("ankaserelektronik.com/crm") && !currentTab.url.includes("samsungcsportal.com/gspn")){
	...
	if(currentTab.url.includes("ankaserelektronik.com/crm")){
